data={
	"locations":[
      ...
      { 
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/blast", "mode/hvv"],
           "offline-modes": ["mode/campaign","mode/team-battle", "mode/onslaught", "mode/duel"]
         }
      },
      { 
         "name":"Crait",
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/blast", "mode/galactic-assault"],
           "offline-modes": ["mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
      { 
         "name":"Death Star II",
      ...
      { 
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/capital-supremacy", "mode/hvv"],
           "offline-modes": []
         }
      },
      { 
         ...
         "summary": {
           "maps": 2,
           "online-modes": ["mode/blast", "mode/ewok-hunt", "mode/galactic-assault", "mode/hero-showdown", "mode/hvv", "mode/strike"],
           "offline-modes": ["mode/campaign","mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
      { 
         "name":"Felucia",
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/capital-supremacy", "mode/co-op"],
           "offline-modes": ["mode/instant-action"]
         }
      },
      { 
         "name":"Geonosis",
         ...
         "summary": {
           "maps": 2,
           "online-modes": ["mode/blast", "mode/capital-supremacy", "mode/co-op", "mode/galactic-assault", "mode/hvv"],
           "offline-modes": ["mode/instant-action", "mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
      { 
         "name":"Hoth",
      ...
      { 
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/blast", "mode/capital-supremacy", "mode/co-op", "mode/galactic-assault", "mode/hero-showdown", "mode/hvv", "mode/strike"],
           "offline-modes": ["mode/battle-scenarios", "mode/instant-action","mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
      { 
         "name":"Kashyyyk",
      ...
      { 
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/blast", "mode/hero-showdown", "mode/hvv", "mode/strike"],
           "offline-modes": ["mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
      { 
      ...
      { 
         ...
         "summary": {
           "maps": 2,
           "online-modes": ["mode/blast", "mode/capital-supremacy", "mode/co-op", "mode/galactic-assault", "mode/hero-showdown", "mode/hvv", "mode/strike"],
           "offline-modes": ["mode/battle-scenarios", "mode/campaign","mode/instant-action","mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
      { 
         "name":"Pillio",
      ...
      { 
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/blast", "mode/galactic-assault", "mode/hero-showdown", "mode/hvv", "mode/strike"],
           "offline-modes": ["mode/battle-scenarios", "mode/campaign","mode/onslaught","mode/team-battle", "mode/duel", "mode/tutorial"]
         }
      },
      { 
         "name":"Sullust",
      ...
      { 
         ...
         "summary": {
           "maps": 1,
           "online-modes": ["mode/blast", "mode/galactic-assault", "mode/hero-showdown", "mode/hvv", "mode/strike"],
           "offline-modes": ["mode/battle-scenarios", "mode/campaign","mode/onslaught","mode/team-battle", "mode/duel"]
         }
      },
	  { 
         "name":"Tatooine",
